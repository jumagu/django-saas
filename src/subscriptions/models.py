...
class Subscription(models.Model):
    ...
    order = models.IntegerField(default=-1, help_text='Ordering on Django princing page')
...
class SubscriptionPrice(models.Model):
    ...
    interval = models.CharField(
        max_length=120,
        default=IntervalChoises.MONTHLY, # get_<field_name>_display
    ...
    def save(self, *args, **kwargs):
        if not self.stripe_id and self.stripe_product_id is not None:
